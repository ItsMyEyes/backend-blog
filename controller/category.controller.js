...
exports.detail = async (req,res) => {
        ...
        include: [
            {
                ...
                order: [['likePosts','id_users', 'desc']],
            }
        ]
    });
    const mostLiked = await categorys.findAll({
        where: {
            url_perma: req.query.url
        },
        include: [
    ...
    return res.status(200).json({ message: "Success one Category", statusCode: 200, data: getData, mostLiked: mostLiked})
}
